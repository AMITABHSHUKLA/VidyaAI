...
st.markdown(f"<style>.st-emotion-cache-6qob1r   {{background-image: url('https://images.pexels.com/photos/1762851/pexels-photo-1762851.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2');background-size: 125%; border: 5px solid #0a0828;border-radius:60px }}</style>", unsafe_allow_html=True)
st.markdown(f"<style>.st-emotion-cache-1wrcr25   {{background-image: url('https://images.pexels.com/photos/743986/pexels-photo-743986.jpeg');background-size: 75%; }}</style>", unsafe_allow_html=True)
